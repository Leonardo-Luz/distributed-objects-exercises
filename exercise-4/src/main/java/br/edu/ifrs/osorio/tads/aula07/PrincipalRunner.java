package br.edu.ifrs.osorio.tads.aula07;

import br.edu.ifrs.osorio.tads.aula07.entity.Colaborador;
import br.edu.ifrs.osorio.tads.aula07.entity.Material;
import br.edu.ifrs.osorio.tads.aula07.entity.Tarefa;
import br.edu.ifrs.osorio.tads.aula07.repository.ColaboradorRepository;
...
public class PrincipalRunner implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        System.out.println("Colaboradores por nome...");
        List<Colaborador> colab = cr.buscaColaboradorPorNome("Pedro de Souza");
        for(Colaborador c: colab){
            System.out.println("Colaborador: " + c.getNome());
        }

        System.out.println("Colaboradores por especialidade...");
        List<String> nomes = cr.buscaColaboradorPorEspecialidade("Pintor");
        for(String e: nomes){
